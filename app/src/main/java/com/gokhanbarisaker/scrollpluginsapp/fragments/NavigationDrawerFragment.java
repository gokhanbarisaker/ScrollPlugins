...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDrawerListView.setAdapter(new ArrayAdapter<String>(
                ...
                android.R.id.text1,
                new String[]{
                        getString(R.string.demo_scrollview),
                        getString(R.string.demo_abslist)
                }));
    ...
    private void selectItem(int position) {
        ...
        if (mCallbacks != null) {
            ...
            Adapter adapter = (mDrawerListView == null)?(null):(mDrawerListView.getAdapter());
            String title = (adapter == null)?(null):((String) adapter.getItem(position));
